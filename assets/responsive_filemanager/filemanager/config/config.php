...
$config = array(
    ...
    */
    ...
    'base_url' => 'http://192.168.188.254/cccinfo/',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'upload_dir' => '/files/upload/source/',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    //'current_path' => '../source/',
    'current_path' => '../../../files/upload/source/',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'thumbs_base_path' => '../../../files/upload/thumbs/',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'thumbs_upload_dir' => '../../files/upload/thumbs/',
