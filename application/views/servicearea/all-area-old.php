                    ...
                    <div class="card card-outline card-info">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <button type="button" id="btnResetFilter2" class="btn btn-sm btn-outline-warning mr-3">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="tableServiceAreaServerside2" class="table table-striped table-bordered" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Alamat</th>
