        ...
        <div class="container-fluid">
            ...
            <div class="card card-outline card-info">
                <div class="card-header">
                    <span class="h5 text-primary">Teknisi Tidak Aktif</span>
                    <div class="card-tools">
                        <a href="<?= base_url('technician/index') ?>" class="text-info mr-2"><i class="fas fa-arrow-circle-left"></i> Back</a>
                    </div>
                </div>
                ...
                <div class="card-body">                    
                    <div class="row">
                        <div class="col">
                            <table class="table table-sm table-hover" id="technicianTableAllInactiveTechnician">
                                <thead>
                                    <tr>
                                        <th>Cabang</th>
                                        <th>Nama PIC</th>
        ...
        <form method="POST" action="" id="formAddTechnician">
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <select type="" class="form-control form-control custom-select" id="formAddTechnicianSvctype" name="formAddTechnicianSvctype">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <select type="" class="form-control form-control custom-select" id="formAddTechnicianSvcbranch" name="formAddTechnicianSvcbranch">
                            <option>- pilih SVC center -</option>
                        </select>
                        <!-- <input type="text" class="form-control form-control custom-select" id="formAddTechnicianSvcbranch" name="formAddTechnicianSvcbranch"> -->
                    </div>
                </div>
                <div class="form-group row">
                    <label for="formAddTechnicianName" class="col-sm-3 col-form-label col-form-label-sm">Nama Teknisi</label>
                    <div class="col-sm-9">
                        <input type="" class="form-control form-control" id="formAddTechnicianName" name="formAddTechnicianName">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="formAddTechnicianPhone1" class="col-sm-3 col-form-label col-form-label-sm">Telepon 1</label>
                    <div class="col-sm-9">
                        <input type="" class="form-control form-control" id="formAddTechnicianPhone1" name="formAddTechnicianPhone1">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="formAddTechnicianPhone2" class="col-sm-3 col-form-label col-form-label-sm">Telepon 2</label>
                    <div class="col-sm-9">
                        <input type="" class="form-control form-control" id="formAddTechnicianPhone2" name="formAddTechnicianPhone2">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="formAddTechnicianPhone3" class="col-sm-3 col-form-label col-form-label-sm">Telepon 3</label>
                    <div class="col-sm-9">
                        <input type="" class="form-control form-control" id="formAddTechnicianPhone3" name="formAddTechnicianPhone3">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="formAddTechnicianPhone4" class="col-sm-3 col-form-label col-form-label-sm">Telepon 4</label>
                    <div class="col-sm-9">
                        <input type="" class="form-control form-control" id="formAddTechnicianPhone4" name="formAddTechnicianPhone4">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="formAddTechnicianRemark" class="col-sm-3 col-form-label col-form-label-sm">Remark</label>
                    <div class="col-sm-9">
                        <input type="" class="form-control form-control" id="formAddTechnicianRemark" name="formAddTechnicianRemark">
                    </div>
                </div>
                <div class="form-group row">
