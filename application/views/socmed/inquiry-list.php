        ...
        <div class="container-fluid pt-3">       
            <div class="card card-info card-outline">
                ...
                <div class="card-body">
                        ...
                        <form method="post">
                            <div class="form-row"  style="min-width: 520px;">
                                ...
                                <div class="text-center" style="width: 150px">
                                    <input type="date" class="custom-select" name="socmedInquiryStartPeriod" id="socmedInquiryStartPeriod" value="<?= $startPeriod ?>">
                                </div>
                                <div class="text-center mx-1">-</div>
                                <div class="text-center" style="width: 150px">
                                    <input type="date" class="custom-select" name="socmedInquiryEndPeriod" id="socmedInquiryEndPeriod" value="<?= $endPeriod ?>">
                                </div>
                                <div class="ml-1" style="width: 100px;">
                                    <button type="submit" class="btn btn-outline-info">Go</button>
                                    <?php if(count($inquiryDataByPeriod) > 0) : ?>
                                        <a href="<?= base_url('socmedinquiry/rawtoexcel/') . $startPeriod . '/' . $endPeriod  ?>">
                    ...
                    <div class="row mt-4">
                        <div class="col">
                            <p class="lead text-center text-primary">Pertanyaan dari Socmed period : <?= date("F Y", strtotime($startPeriod)) ?> - <?= date("F Y", strtotime($endPeriod)) ?></p>
                            
                            <table class="table table-sm table-bordered" id="socmedTableInquryList">
                                <thead>
                                    <tr class="text-center">
                                        <th class="align-middle">#</th>
                                        <th class="align-middle">Chnel</th>
                                ...
                                <tbody>
                                    <?php $i = 1; ?>
                                    <?php foreach($inquiryDataByPeriod as $row) : ?>
                                        <tr>
                                            <td><?= $i++ ?></td>
                                            <td class="text-center h5"><?= channeltoIcon($row['socmed_type']) ?></td>
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right p-2" style="min-width: 420px;">
                                                        ...
                                                        <table class="table table-sm table-borderless">
                                                            <tbody>
                                                                <tr class="border-top">
                                                                    <td class="py-2">
                                                                        <a href="<?= base_url('socmedinquiry/edit/') . $row['id'] ?>"><i class="fas fa-edit"></i> Edit data</a>
                                                                    </td>
                                                                </tr>
                                                                <?php if (in_array($this->session->userdata('useraccess'), $allowedAccess)) : ?>
                                                                    <tr class="border-top">
                                                                        <td class="py-2">
                                                                            <a class="text-danger buttonSocmedlistDelete"  data-id="<?= $row['id']; ?>" data-period="<?= $row['id']; ?>" title="Delete data" style="cursor: pointer; text-decoration: none;">
