                    ...
                    <form action="" method="POST">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-auto">
                                <input type="text" class="form-control" name="emailInsertDatetime" id="emailInsertDatetime" value=""  style="min-width: 220px; max-width:230px;">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <select type="text" class="custom-select js-example-basic-single" name="emailInsertProductCategory" id="emailInsertProductCategory"  style="min-width: 220px; max-width:240px;">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <select type="text" class="custom-select js-example-basic-single" name="emailInsertSystemCode" id="emailInsertSystemCode"  style="min-width: 220px; max-width:240px;">
                                    <option value=""> - pilih - </option>
